...
// 📘 صفحة متفرقات
export default function AmnfkryAudio() {
  const [lessons, setLessons] = useState([]);

  useEffect(() => {
    fetch("/data/amnfkryaudio.json")
      .then((res) => res.json())
  ...
  return (
    <div style={{ maxWidth: 900, margin: "20px auto", padding: 20 }}>
      <h1 style={{ textAlign: "center", color: "green", fontWeight: "bold", marginBottom: "20px" }}>الأمن الفكري</h1>
